...
To be clear about our interest: any spec-compliant OAuth 2.1 MCP gateway provides this lane — [we compare the open-source options honestly](/alternatives/open-source-mcp-gateways/), and Cortex is the one we maintain. The architecture is the recommendation; the product is a choice.
