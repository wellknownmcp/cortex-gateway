...
Pour être clair sur notre intérêt : n'importe quelle gateway MCP OAuth 2.1 conforme fournit cette voie — [nous comparons honnêtement les options open source](/alternatives/open-source-mcp-gateways/), et Cortex est celle que nous maintenons. La recommandation, c'est l'architecture ; le produit, c'est un choix.
